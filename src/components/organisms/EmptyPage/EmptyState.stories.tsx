...
const EmptyState: React.FC<EmptyStateProps> = ({ icon, heading, description, buttonLabel, onButtonClick }) => (
	<div className='bg-[#fafafa] border border-[#E9E9E9] rounded-[6px] w-full h-[360px] flex flex-col items-center justify-center mx-auto'>
		...
		{description && (
			<div className='font-normal text-[16px] leading-normal text-gray-400 mb-8 text-center max-w-[350px]'>{description}</div>
		)}
